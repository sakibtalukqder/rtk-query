...
import { useGetUserByIdQuery } from "../../Api/ContextApi";
...
const View = () => {
    ...
    return (
        <header className="px-2 py-4 flex flex-col justify-center items-center text-center mt-28">
            <img 
            className="h-48 w-48 inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600" 
